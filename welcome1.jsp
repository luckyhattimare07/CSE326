...
<body>
	...
	<%
		try {
			...
			String sql = "insert into trans values('" + request.getParameter("t1") + "','"
					+ request.getParameter("t2") + "','" + request.getParameter("t3") + "','"
	...
	<div class="jumbotron">
		...
		<hr class="my-4">
		<p>We are Informe you to ask With Donor and Your Proccess is Done</p>
